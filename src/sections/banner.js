          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              <Box sx={styles.banner.stars}>
                ...
                <FaStar />
                <FaStar />
                Aprovado por mais de 2.324 alunos
              </Box>
              <Heading as="h3">
              ...
              <Text as="p">
              Fazer um curso de culinária pode abrir várias possibilidades <br />
              profissionais que podem lhe proporcionar a tão sonhada <br />
              independência financeira através de um negócio próprio.
              </Text>
              <Box as="form" sx={styles.banner.form}>
                ...
                <Input
                  name="search"
                  id="search"
                  placeholder="Pesquisa o nome do curso"
